...
const HeaderFooter: FunctionComponent<HeaderFooterType> = ({
  propHeight,
  propPadding,
}) => {
  ...
  return (
    <section className={styles.headerFooter}>
      ...
      <footer className={styles.footer}>
        ...
        <div className={styles.socials}>
          <button className={styles.iconstiktokAndYouTube}>
            <img
          ...
          <button className={styles.iconstiktokAndYouTube1}>
            <img
        ...
        <div className={styles.contacts} style={contactsStyle}>
